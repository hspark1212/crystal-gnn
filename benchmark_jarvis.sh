...
python run.py with model_name=nequip exp_name=nequip_formation_energy_peratom database_name=dft_3d_2021 target=formation_energy_peratom
...
python run.py with model_name=nequip exp_name=nequip_optb88vdw_bandgap database_name=dft_3d_2021 target=optb88vdw_bandgap
...
python run.py with model_name=nequip exp_name=nequip_ehull database_name=dft_3d_2021 target=ehull
...
python run.py with model_name=nequip exp_name=nequip_bulk_modulus_kv database_name=dft_3d_2021 target=bulk_modulus_kv
...
python run.py with model_name=nequip exp_name=nequip_shear_modulus_gv database_name=dft_3d_2021 target=shear_modulus_gv